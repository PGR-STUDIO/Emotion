...
function insertDynamicPanels() {
  ...
  $('#exercise').insertAdjacentHTML('beforebegin', '<section id="sense" class="screen"><button id="senseBack" class="back-inline">← Comprendre</button><div class="progress"><span class="active"></span><span class="active"></span><span class="active"></span><span></span><span></span></div><p class="step">ÉTAPE 3 SUR 5</p><h2>Que ressens-tu ?</h2><p class="hint">Observe les signes dans ton corps, puis situe ton intensité.</p><div id="senseContent"></div></section>');
